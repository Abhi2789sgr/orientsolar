	...
	<table id="id01" class="w3-table-all m8-fancy" style="overflow-y:scroll; overflow-x:scroll; height:400px;">
		<thead>
			<tr class="w3-color">
				...
				<th>Harvested Energy per day </th>
				<th>Cumulated Harvested energy </th>
...
<script>
	...
	function onStart() {
		if (localStorage.temp_name != undefined && localStorage.temp_imei != undefined) {
			...
			w3.getHttpObject("../Controller/admin/getLog.php?imei=" + imei + '&limit=50&pageNo=' + pageNo, myFunction);
