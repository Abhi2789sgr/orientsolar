...
<div class="w3-row-padding w3-margin-bottom">
	...
	<div class="w3-quarter w3-button">
		<div class="w3-container w3-red w3-padding-16 w3-hover-amber m8-fancy" onclick="window.location.assign('?item=7')" style="height: 114px;">
			<div class="w3-left"><i class="fa fa-lightbulb-o w3-xxxlarge"></i></div>
			<div class="w3-right">
			...
			$twentyHoursAgo = date('Y-m-d H:i:s', strtotime('-3 days'));

			$query = "SELECT device FROM _g_data_latest WHERE time <= '{$twentyHoursAgo}' AND device IN (".$userDevices.")";
...
<div class="w3-container w3-responsive w3-small m8-fancy">
	<table id="id01" class="w3-table-all m8-fancy" style="overflow-y:scroll; overflow-x:scroll; height:400px;">
		<thead>
			<tr class="w3-color">
				...
				<th>SSL Current</th>
				<th>SSL Power</th>
				<th>Full Brightness Hours</th>
				<th>Half Brightness Hours</th>
				<th>Total Glowing Hours</th>
				<th>Harvested Energy per day(WH)</th>
				<th>Cumulated Harvested Energy (KWH)</th>
