...
<div class="" style="display:none; float: right; width:72%;" id="txtHint">
    <div class="w3-container">
        ...
        <div class="w3-row w3-color w3-center w3-padding m8-fancy">
            <div class="w3-col s6 m6 l6">
                <div><b>Last Reporting Date & Time</b></div>
            </div>
            <div class="w3-col s6 m6 l6">
                <div id="lastTime"></div>
            </div>
    ...
    <div class="w3-col s6 m3 l3" style="padding:5px;"><button class="w3-button w3-color m8-fancy" style="width:100%;" onclick="deleteInventory()"><i class="fa fa-trash"></i> Delete</button></div>
</div>
...
<div id="id05" class="w3-modal">
    <div class="w3-modal-content w3-animate-top w3-card-4" style="width:400px;height:auto;height:200px;">
        ...
        <div class="w3-padding">
            ...
            <input class="w3-input w3-border" id="skey" placeholder="Security Key Here" type="text" required>
...
<script>
    ...
    function inventorySearch(search = '') {
        ...
        timerId = setTimeout(function() {
            xhr.open("POST", "../Controller/admin/inventorySearch.php");
    ...
    function saveInventory() {
        ...
        if (deviceIMEI == "" && inventoryArr.toString() == "") {
            ...
            const formData = new FormData();
            formData.append("imei", postData);

            var url = "../Controller/addInventory.php";
    ...
    function getLog(deviceImei) {
        ...
        xhttp.onload = function() {
            ...
            w3.id('log_imei').innerHTML = deviceImei;
