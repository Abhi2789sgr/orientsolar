...
<div class="w3-container w3-margin-bottom w3-row">
	...
	<div class="w3-button w3-color w3-right w3-margin m8-fancy" id="exportReport" onclick="exportReport()">Export Report</div>
	<h2 id="heading"></h2>
	<div class="w3-row">
		...
		<div class="w3-threequarter" style="display:none;" id="id03">
			...
			<div class="w3-container">
				...
				<div class="w3-row">
					...
					<div class="w3-col s6 m3 l3" style="padding:5px;"><button class="w3-button w3-color m8-fancy" style="width:100%;" onclick='window.location.assign("?item=10")'><i class="fa fa-file"></i> ON/OFF logs</button></div>
					<div class="w3-col s6 m3 l3" style="padding:5px;"><button class="w3-button w3-color m8-fancy" style="width:100%;" onclick='deleteDevice(w3.id("log_imei").innerHTML);'><i class="fa fa-trash"></i> Delete</button></div>
				</div>
			</div>
		</div>
	</div>
...
<script>
	...
	function myFunction(myObject) {
		...
		var temp_id = myObject.parent_id;
		...
		if (heading.innerHTML == "DISTRICT LIST" || heading.innerHTML == "") {
			project_id = temp_id;
			district_id = "";
			block_id = "";
			panchayat_id = "";
	...
	function deleteDeviceFor(dev_id) {
		...
		ajax("../Controller/user/deleteDevice.php", param);
