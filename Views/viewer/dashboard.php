	...
	<table id="id01" class="w3-table-all m8-fancy" style="overflow-y:scroll; overflow-x:scroll; height:400px;">
		<thead>
			<tr class="w3-color">
				...
				<th>SSL Current</th>
				<th>SSL Power</th>
				<th>Full Working Hours</th>
				<th>Dim Working Hours</th>
...
<script>
	...
	loadList("district", parseInt(project));
	...
	function enableBtn() {
		//console.log("Enable: "+district.value + " " + startDate.value + " " + endDate.value);
		if (district.value != "" && (startDate.value && endDate.value) && (startDate.value <= endDate.value)) {
