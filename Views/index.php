...
<div class="w3-bar w3-top w3-large w3-card-4" style="z-index:4;background-color:#fff;color:#fff;">
  ...
  <span class="w3-bar-item w3-hide-small" style="background-color:#e05220;height:61px;padding-top:13px;"><b><?php echo $project_name; ?></b></span>
  <span class="w3-bar-item w3-hide-medium w3-hide-large" style="background-color:#e05220;height:61px;padding-top:13px;"><b>OrentRMS</b></span>
  ...
  <span class="w3-hide-small w3-right w3-xlarge w3-margin-right" style="margin-top:10px;color:#e05220;">मुख्यमंत्री ग्रामीण सोलर स्ट्रीट लाइट योजना</span>
</div>

<div class="w3-display-container" style="height:600px;margin-top:50px;">
    <div class="w3-display-right w3-padding">
		<div class="w3-panel w3-card-4 w3-round-large w3-center margin-rt50" style="background-color:#fff;color:#e05220;">
			...
			<form class="" action="../Controller/login.php" method="POST">
				<div class="w3-section">
					...
					<button class="w3-btn w3-border w3-round-large w3-margin-top w3-center w3-text-white" style="width:300px;background-color:#e05220;" type="submit">Login</button>
				</div>
			</form>
