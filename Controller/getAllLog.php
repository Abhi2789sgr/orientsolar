...
if ($uid == "admin") {
	$sql = "SELECT _g_data_latest.id,_g_data_latest.time,dev_id as device,name,v1,v2,v3,v4,v5,v6,v7,v8,v9,v10,v11,v12,v13,v14,v15,v16,v17,v18,v19,v20,lat,lng FROM _f_device left join _g_data_latest on dev_id=device WHERE 1 AND device LIKE '%$search%' ORDER BY _g_data_latest.id DESC LIMIT $offset,$limit";
} else {
	$branch = 6;
	$branch_value = 0;
	...
	if ($result->num_rows > 0) {
		...
		if(intval($row["branch"]) <= 6){
			$branch = explode("_", $tree[$row["branch"]])[2];
			$branch_value = $row["branch_value"];
		}
	}
	if($search != ""){
		$sql = "SELECT _g_data_latest.id,_g_data_latest.time,dev_id as device,name,v1,v2,v3,v4,v5,v6,v7,v8,v9,v10,v11,v12,v13,v14,v15,v16,v17,v18,v19,v20,lat,lng FROM _f_device left join _g_data_latest on dev_id=device WHERE " . $branch . "=" . $branch_value . " AND device LIKE '%$search%' ORDER BY _g_data_latest.id DESC LIMIT $offset,$limit";
	}else{
		$sql = "SELECT _g_data_latest.id,_g_data_latest.time,dev_id as device,name,v1,v2,v3,v4,v5,v6,v7,v8,v9,v10,v11,v12,v13,v14,v15,v16,v17,v18,v19,v20,lat,lng FROM _f_device left join _g_data_latest on dev_id=device WHERE " . $branch . "=" . $branch_value . " ORDER BY _g_data_latest.id DESC LIMIT $offset,$limit";
	}
}
